    ...
    ([
        ...
        function(module, exports, __webpack_require__) {
            ...
            exports.inherit = function(parent, extra) {
                return exports.extend(new(exports.extend(function() {}, {
                    prototype: parent
                }))(), extra);
            };
            /**
            ...
            function omit(obj) {
                return pickOmitImpl.apply(null, [hof_1.not(exports.inArray)].concat(restArgs(arguments)));
            }
            exports.omit = omit;
            /**
        ...
        function(module, exports, __webpack_require__) {
            ...
            var Transition = (function() {
                ...
                function Transition(fromPath, targetState, router) {
                    ...
                    var rootResolvables = [
                        new resolvable_1.Resolvable(router_1.UIRouter, function() {
                            return router;
                        }, [], undefined, router),
                        new resolvable_1.Resolvable(Transition, function() {
                            return _this;
                        }, [], undefined, this),
                        new resolvable_1.Resolvable('$transition$', function() {
                            return _this;
                        }, [], undefined, this),
                        new resolvable_1.Resolvable('$stateParams', function() {
                            return _this.params();
            ...
            var Trace = (function() {
                ...
                Trace.prototype.traceHookInvocation = function(step, options) {
                    ...
                    var tid = hof_1.parse("transition.$id")(options),
                        ...
                        name = strings_1.functionToString(step.fn);
                ...
                Trace.prototype.traceHookResult = function(hookResult, transitionResult, transitionOptions) {
                    ...
                    var tid = hof_1.parse("transition.$id")(transitionOptions),
                        ...
                        transitionResultStr = strings_1.stringify(transitionResult);
            ...
            var TransitionHook = (function() {
                ...
                TransitionHook.prototype.handleHookResult = function(hookResult) {
                    ...
                    var mapHookResult = hof_1.pattern([
                        ...
                        [this.isSuperseded,
                            function() {
                                return rejectFactory_1.Rejection.superseded(_this.options.current()).toPromise();
                            }
                        ],
                        ...
                        [hof_1.is(targetState_1.TargetState),
                            function(target) {
                                return rejectFactory_1.Rejection.redirected(target).toPromise();
                            }
                        ],
                        // A promise was returned, wait for the promise and then chain another hookHandler
                        [predicates_1.isPromise,
                            function(promise) {
                ...
                TransitionHook.prototype.toString = function() {
                    ...
                    var event = hof_1.parse("traceData.hookType")(options) || "internal",
                        context = hof_1.parse("traceData.context.state.name")(options) || hof_1.parse("traceData.context")(options) || "unknown",
                        name = strings_1.fnToString(hookFn);
            ...
            var HookBuilder = (function() {
                function HookBuilder($transitions, transition, baseHookOptions) {
                    ...
                    this.getOnBeforeHooks = function() {
                        return _this._buildNodeHooks("onBefore", "to", tupleSort(), {
                            async: false
                        });
                    };
                    ...
                    this.getOnExitHooks = function() {
                        return _this._buildNodeHooks("onExit", "exiting", tupleSort(true), {
                            stateHook: true
                        });
                    };
                    this.getOnRetainHooks = function() {
                        return _this._buildNodeHooks("onRetain", "retained", tupleSort(false), {
                            stateHook: true
                        });
                    };
                    this.getOnEnterHooks = function() {
                        return _this._buildNodeHooks("onEnter", "entering", tupleSort(false), {
                            stateHook: true
                        });
                    };
            ...
            var Resolvable = (function() {
                ...
                Resolvable.prototype.resolve = function(resolveContext, trans) {
                    ...
                    var waitForRx = function(observable$) {
                        ...
                        return cached.toPromise().then(function() {
                            return cached;
                        });
                    };
                    ...
                    var maybeWaitForRx = this.getPolicy(state).async === "RXWAIT" ? waitForRx : function(x) {
                        return x;
                    };
                ...
                PathFactory.treeChanges = function(fromPath, toPath, reloadState) {
                    ...
                    var staticParams = function(state) {
                        return state.parameters({
                            inherit: false
                        }).filter(hof_1.not(hof_1.prop('dynamic'))).map(hof_1.prop('id'));
                    };
        ...
        function(module, exports, __webpack_require__) {
            ...
            var PathNode = (function() {
                ...
                PathNode.prototype.equals = function(node, keys) {
                    var _this = this;
                    if (keys === void 0) {
                        keys = this.paramSchema.map(hof_1.prop('id'));
                    }
            ...
            var ParamTypes = (function() {
                function ParamTypes() {
                    ...
                    var makeType = function(definition, name) {
                        return new type_1.ParamType(common_1.extend({
                            name: name
                        }, definition));
                    };
                ...
                ParamTypes.prototype.type = function(name, definition, definitionFn) {
                    ...
                    this.types[name] = new type_1.ParamType(common_1.extend({
                        name: name
                    }, definition));
                    if (definitionFn) {
                        this.typeQueue.push({
        ...
        function(module, exports, __webpack_require__) {
            ...
            var TransitionService = (function() {
                ...
                TransitionService.prototype.registerTransitionHooks = function() {
                    ...
                    fns.redirectTo = this.onStart({
                        to: function(state) {
                            return !!state.redirectTo;
                        }
                    }, redirectTo_1.redirectToHook);
                    // Wire up onExit/Retain/Enter state hooks
                    fns.onExit = this.onExit({
                        exiting: function(state) {
                            return !!state.onExit;
                        }
                    }, onEnterExitRetain_1.onExitHook);
                    fns.onRetain = this.onRetain({
                        retained: function(state) {
                            return !!state.onRetain;
                        }
                    }, onEnterExitRetain_1.onRetainHook);
                    fns.onEnter = this.onEnter({
                        entering: function(state) {
                            return !!state.onEnter;
                        }
                    }, onEnterExitRetain_1.onEnterHook);
                    // Wire up Resolve hooks
                    fns.eagerResolve = this.onStart({}, resolve_1.eagerResolvePath, {
                        priority: 1000
                    });
                    fns.lazyResolve = this.onEnter({
                        entering: hof_1.val(true)
                    }, resolve_1.lazyResolveState, {
                        priority: 1000
                    });
                    ...
                    fns.updateUrl = this.onSuccess({}, url_1.updateUrl, {
                        priority: 9999
                    });
                };
                /** @inheritdoc */
        ...
        function(module, exports, __webpack_require__) {
                    ...
                    var url = !parsed ? stateDec.url : $urlMatcherFactoryProvider.compile(parsed.val, {
                        ...
                        paramMap: function(paramConfig, isSearch) {
                            if (stateDec.reloadOnSearch === false && isSearch)
                                paramConfig = common_1.extend(paramConfig || {}, {
                                    dynamic: true
                                });
                            return paramConfig;
                        }
            ...
            function paramsBuilder(state) {
                var makeConfigParam = function(config, id) {
                    return param_1.Param.fromConfig(id, null, config);
                };
            ...
            function resolvablesBuilder(state) {
                ...
                var obj2Tuples = function(obj) {
                    return Object.keys(obj || {}).map(function(token) {
                        return ({
                            token: token,
                            val: obj[token],
                            deps: undefined
                ...
                var literal2Resolvable = hof_1.pattern([
                    ...
                    [hof_1.prop('useExisting'),
                        function(p) {
                            return new resolvable_1.Resolvable(token(p), function(x) {
                                return x;
                            }, [p.useExisting], p.policy);
                        }
                    ],
                ]);
                var tuple2Resolvable = hof_1.pattern([
                    [hof_1.pipe(hof_1.prop("val"), predicates_1.isString),
                        function(tuple) {
                            return new resolvable_1.Resolvable(tuple.token, function(x) {
                                return x;
                            }, [tuple.val], tuple.policy);
                        }
                    ],
                ...
                var item2Resolvable = hof_1.pattern([
                    [hof_1.is(resolvable_1.Resolvable),
                        function(r) {
                            return r;
                        }
                    ],
                    ...
                    [hof_1.val(true),
                        function(tuple) {
                            throw new Error("Invalid resolve value: " + strings_1.stringify(tuple));
                        }
                    ]
                ]);
        ...
        function(module, exports, __webpack_require__) {
            ...
            var StateService = (function() {
                ...
                StateService.prototype._handleInvalidTargetState = function(fromPath, $to$) {
                    ...
                    var $q = coreservices_1.services.$q,
                        $injector = coreservices_1.services.$injector;
                ...
                StateService.prototype.transitionTo = function(to, toParams, options) {
                    ...
                    options = common_1.extend(options, {
                        current: transHistory.peekTail.bind(transHistory)
                    });
                    ...
                    var transitionToPromise = transition.run().
            ...
            var Globals = (function() {
                function Globals(transitionService) {
                    ...
                    var beforeNewTransition = function($transition$) {
                        ...
                        $transition$.onSuccess({}, updateGlobalState, {
                            priority: 10000
                        });
        ...
        function(module, exports, __webpack_require__) {
            ...
            angular.module('ui.router.init').run(['ng1UIRouter',
                function(ng1UIRouter) {}
            ]);
            // $urlMatcherFactory service and $urlMatcherFactoryProvider
            angular.module('ui.router.util').provider('$urlMatcherFactory', ['ng1UIRouterProvider',
                function() {
            ...
            angular.module('ui.router.router').run(['$urlRouter',
                function($urlRouter) {}
            ]);
            ...
            angular.module('ui.router.state').run(['$state',
                function($state) {}
            ]);
            // $stateParams service
            angular.module('ui.router.state').factory('$stateParams', ['ng1UIRouter',
                function(ng1UIRouter) {
                    return ng1UIRouter.globals.params;
                }
            ]);
            ...
            angular.module('ui.router.util').factory('$templateFactory', ['ng1UIRouter',
                function() {
        ...
        function(module, exports, __webpack_require__) {
            ...
            var $resolve = {
                ...
                resolve: function(invocables, locals, parent) {
                    ...
                    context.addResolvables(stateBuilder_1.resolvablesBuilder({
                        resolve: invocables
                    }), node.state);
                    var resolveData = function(parentLocals) {
                        var rewrap = function(_locals) {
                            return stateBuilder_1.resolvablesBuilder({
                                resolve: common_1.map(_locals, function(local) {
                                    return function() {
                                        return local;
                                    };
                                })
        ...
        function(module, exports, __webpack_require__) {
            ...
            function ng1ViewsBuilder(state) {
                ...
                var views = {}, viewsObject = state.views || {
                        "$default": common_1.pick(state, allKeys)
                    };
                common_1.forEach(viewsObject, function(config, name) {
                    ...
                    if (config.component) {
                        ...
                        config.templateProvider = ['$injector',
                            function($injector) {
            ...
            exports.getStateHookBuilder = function(hookName) {
                return function stateHookBuilder(state, parentFn) {
                    ...
                    function decoratedNg1Hook(trans, state) {
                        ...
                        return coreservices_1.services.$injector.invoke(hook, this, common_1.extend({
                            $state$: state
                        }, services_1.getLocals(resolveContext)));
                    }
                    ...
                    return {
                        ...
                        controller: ['$scope', '$element', '$attrs', '$timeout',
                            function($scope, $element, $attrs, $timeout) {
                                ...
                                $scope.$on('$destroy', $transitions.onStart({}, function(trans) {
                                    return trans.promise.then(update) && null;
                                }));
