    ...
    function(a, b, c) {
        ...
        function r(a, b, e) {
            ...
            var i, j = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g,
                ...
                m = 0,
                n = this.segments = [],
                o = e ? e.params : {}, p = this.params = e ? e.params.$$new() : new U.ParamSet,
                q = [];
            this.source = a;
            for (var r, s, t;
            ...
            function v(a, e, f, h, l, n, p, q, t) {
                ...
                return x.locals = {
                    ...
                    if (f.reload) {
                        ...
                        for (; F && F === o[D] && F.ownParams.$$equals(c, l);) G = H[D] = F.locals, D++, F = z[D]; if (w(b, c, j, l, G, f)) return r && (c["#"] = r), y.params = c, S(y.params, n), S(k(b.params.$$keys(), n), b.locals.globals.$stateParams), f.location && b.navigable && b.navigable.url && (p.push(b.navigable.url, c, {
                        $$avoidResync: !0,
                            ...
                            function l(h) {
                                ...
                                if (h || u !== p) {
                                    ...
                                    var v = i(l, function(a) {
                                        ...
                                        s.enter(a.data("$uiView", i), g, function() {
                                            e.resolve(), o && o.$emit("$viewContentAnimationEnded"), (b.isDefined(r) && !r || c.$eval(r)) && d(a)
                                        }), k()
                                    });
                                    n = v, o = l, o.$emit("$viewContentLoaded", m), o.$eval(q)
                                }
                            }
                            var m, n, o, p, q = j.onload || "",
                                r = j.autoscroll,
                                s = h(j, c),
                                t = g.inheritedData("$uiView");
                    ...
                    return function(e, g, h) {
                        ...
                        if (k) {
                            ...
                            if (k.$$controller) {
                                ...
                                var n = c(k.$$controller, k);
                                k.$$controllerAs && (e[k.$$controllerAs] = n, e[k.$$controllerAs][k.$$resolveAs] = l), M(n.$onInit) && n.$onInit(), g.data("$ngControllerController", n), g.children().data("$ngControllerController", n)
                            }
                            m(e)
                        }
                    }
        ...
        function A(a, b, c, d) {
            ...
            return e.indexOf("@") >= 0 ? e : e + "@" + (c ? c.state.name : "")
        }
